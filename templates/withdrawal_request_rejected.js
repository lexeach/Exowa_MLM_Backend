...
const message = (inovice, fullname, time, deposit_amount, deposit_dollar, payment_mode, payment_ref, support_email, status, comment) => {
  ...
  <body>
    <div class="email-container">
      <div class="Registration_Successful">
        <h1>Withdrawal Invoice - ${inovice} from AUTASIS</h1>
      </div>
      ...
      <div style="padding: 30px">
        <div class="marginBottom">
          ...
          <p>
            Thank you for your withdrawal! We’ve send your payment, and your invoice is now available for your records.
          </p>
        </div>
        <div class="marginBottom">
            ...
            <p class="details"><span>Withdrawal Request Status:</span> ${status}</p> 
            <p class="details"><span>Withdrawal Request Rejection Reason:</span> ${comment}</p>            
        </div>
