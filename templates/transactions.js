                         ...
                         <h1 class="text" style="  border-radius: 5px; color:#000;font-family:roboto;font-size:16px; text-align: center; font-weight: 400; font-style:normal;letter-spacing:0.8px;line-height:22px;text-transform:none;padding:8px;margin:0 auto"> 
                          ...
                          <table style="width:100%; border:1px solid #d7cccc; color:#747070;padding: 10px; font-size: 20px;border-radius: 7px;" >
                            <tr>
                              ...
                              <td style="text-align: right; padding: 4px; ">12345678</td>
                            
                            </tr>
                            <tr style="width:100%; border:1px solid black">
                              <td style="color:black;font-weight: 600">Amount</td>
                              <td style="text-align: right;padding: 4px;">12345 USDT</td>
                            
                            </tr>
                            <tr style="width:100%; border:1px solid black">
                              <td style="color:black;font-weight: 600">Receiver Hash</td>
                              <td style="text-align: right;padding: 4px;">123455345dkhaskf242af</td>
                            ...
                            <tr>
                              ...
                              <tr style="width:100%; border:1px solid black">
                                <td style="color:black;font-weight: 600">Transactions ID</td>
                                <td style="text-align: right;padding: 4px;">123455345dkhaskf242af</td>
